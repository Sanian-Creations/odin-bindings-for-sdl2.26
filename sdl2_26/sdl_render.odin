...
foreign lib {
	...
	RenderGeometryRaw            :: proc(renderer: ^Renderer, texture: ^Texture, xy: [^]f32, xy_stride: c.int, color: [^]Color, color_stride: c.int, uv: [^]f32, uv_stride, num_vertices: c.int, indices: rawptr, num_indices, size_indices: c.int) -> c.int ---

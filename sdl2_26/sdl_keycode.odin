...
Keycode :: enum i32 {
    ...
    SOFTLEFT = auto_cast (Scancode.SOFTLEFT|SCANCODE_MASK),
    SOFTRIGHT = auto_cast (Scancode.SOFTRIGHT|SCANCODE_MASK),
    CALL = auto_cast (Scancode.CALL|SCANCODE_MASK),
    ENDCALL = auto_cast (Scancode.ENDCALL|SCANCODE_MASK),
}

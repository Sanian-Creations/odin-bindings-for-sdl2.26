...
VirtualJoystickDesc :: struct {
	...
	Update:         proc(userdata: rawptr), /**< Called when the joystick state should be updated */
	SetPlayerIndex: proc(userdata: rawptr, player_index: c.int), /**< Called when the player index is set */
	Rumble:         proc(userdata: rawptr, low_frequency_rumble, high_frequency_rumble: u16) -> c.int, /**< Implements SDL_JoystickRumble() */
	RumbleTriggers: proc(userdata: rawptr, left_rumble, right_rumble: u16) -> c.int, /**< Implements SDL_JoystickRumbleTriggers() */
	SetLED:         proc(userdata: rawptr, red, green, blue: u8) -> c.int, /**< Implements SDL_JoystickSetLED() */
	SendEffect:     proc(userdata: rawptr, data: rawptr, size: c.int) -> c.int, /**< Implements SDL_JoystickSendEffect() */
}
